...
namespace Ryujinx.Ava.Common
{
    internal static class ApplicationHelper
    {
        ...
        public static void CreateSaveDir(ulong titleId, BlitStruct<LibHac.Ns.ApplicationControlProperty> nacpData)
        {
            ...
            LibHac.Result resultCode = _horizonClient.Fs.EnsureApplicationCacheStorage(out _, out _, applicationId, in control);
            ...
            Uid userId = _accountManager.LastOpenedUser.UserId.ToLibHacUid();

            resultCode = _horizonClient.Fs.EnsureApplicationSaveData(out _, applicationId, in control, in userId);
            if (resultCode.IsFailure())
            {
