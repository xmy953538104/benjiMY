...
namespace LibKenjinx
{
    public static partial class LibKenjinx
    {
        ...
        public static bool InitializeDeviceNative(MemoryManagerMode memoryManagerMode,
                                                  bool useHypervisor,
        ...
        {
            return InitializeDevice(memoryManagerMode,
                                    useHypervisor,
                                    memoryConfiguration,
                                    systemLanguage,
                                    regionCode,
        ...
        public static void SetVsyncStateNative(VSyncMode vSyncMode)
        {
            SetVsyncState(vSyncMode);
        }
        ...
        [UnmanagedCallersOnly(EntryPoint = "device_reinit_emulation")]
        public static void ReinitEmulationNative()
        {
            ReinitEmulation();
        }
